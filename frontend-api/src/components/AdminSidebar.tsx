...
const AdminSidebar: React.FC = () => {
  ...
  return (
    <nav className="border border-gray-300 rounded-md w-72 h-screen flex-col justify-between flex ">
      <div className="bg-sky-100 h-full">
        <div className="flex justify-center py-10 shadow-sm pr-4">
          ...
          <div className="pl-2">
            ...
            <span className="text-xs block text-gray-800">Moutain</span>
          </div>
        </div>
        <div className="pl-10">
      ...
      <div
        className="bg-sky-100 flex items-center space-x-4 pl-10 pb-10 hover:text-indigo-600 cursor-pointer"
