      ...
      <div className="bg-white p-6 rounded-xl shadow-lg w-full md:w-1/2 border border-gray-300 flex-grow">
        ...
        <div className="mb-4 border border-gray-300 rounded-lg p-4 bg-gray-50">
          ...
          {activeSection === "dressCode" && (
            <div className="mt-2 text-gray-600 text-sm">
              <p>
                Guests are expected to wear comfortable, family-friendly attire.
                No offensive slogans or images are allowed on clothing.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="mb-4 border border-gray-300 rounded-lg p-4 bg-gray-50">
          ...
          {activeSection === "specialServices" && (
            <div className="mt-2 text-gray-600 text-sm">
              <p>
                Wheelchairs & Pram are available for Sr. Citizens and Toddlers.
              </p>
            </div>
          )}
        </div>
          ...
          {activeSection === "terms" && (
            <div className="mt-2 text-gray-600 text-sm">
              <ul className="list-disc list-inside">
                ...
                <li>
                  Entry is restricted to one person per ticket, which is valid
                  only for a date and specified time.
                </li>
                <li>Tickets are non-transferable.</li>
                <li>
                  Foods from outside and alcoholic drinks are not allowed inside
                  the park.
                </li>
              </ul>
            </div>
