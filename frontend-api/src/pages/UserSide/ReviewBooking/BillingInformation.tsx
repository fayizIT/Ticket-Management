...
const BillingInformation: React.FC<BillingInformationProps> = ({
      ...
      <form className="space-y-3">
        <div>
          ...
          <input
            ...
            className="w-full p-1.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-900 bg-blue-50 placeholder-custom-blue placeholder-opacity-40"
            placeholder="Enter full name"
          />
        </div>
        <div>
  <label className="block text-blue-900 text-sm mb-1">Phone Number</label>
  <div className="flex items-center rounded-lg overflow-hidden border border-gray-300 bg-blue-50">
    ...
    <div className="flex items-center px-3 border-r border-gray-300 bg-blue-100">
      ...
      />
      <span className="text-blue-900 text-sm font-medium">+91</span>
    </div>
    ...
    <input
      ...
      onChange={handleChange}
      className="w-full p-2 bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-900 placeholder-custom-blue placeholder-opacity-40"
    ...
    />
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleChange}
            className="w-full p-1.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-900 h-10 resize-none bg-blue-50 placeholder-custom-blue placeholder-opacity-40"
            placeholder="Enter PIN Code "
          />
        </div>
      </form>

      <p className="text-sm text-[#15196E] opacity-40 text-center mt-3">
