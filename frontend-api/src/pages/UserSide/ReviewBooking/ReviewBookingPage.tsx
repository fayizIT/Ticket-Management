...
const ReviewBookingPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full sm:w-4/5 mx-auto mt-6 flex flex-col md:flex-row justify-center items-start space-y-4 md:space-y-0 md:space-x-4 px-2 sm:px-0">
        <div className="flex-1 max-w-full md:max-w-lg w-full h-auto"> {/* Increase max-w-md to max-w-lg */}
          <BookingSummary 
        ...
        <div className="flex-1 max-w-full md:max-w-lg w-full h-auto"> {/* Same change here */}
          <BillingInformation 
            formData={formData}
