...
// import { fetchTicketCategories } from "../../redux/ticketSlice";
...
//   // Select ticket categories from Redux
...
//   // Fetch ticket categories when component mounts
//   useEffect(() => {
//     dispatch(fetchTicketCategories() as any);
//   }, [dispatch]);

//   // Log the categories after fetching
//   useEffect(() => {
//     if (categories && categories.length > 0) {
//     }
//   }, [categories]);

//   // Handle incrementing/decrementing ticket counts
...
//       // console.log("Updating ticket count for", id, "to", newCount);
//       return { ...prevCounts, [id]: newCount };
//     });
//   };

//   // Calculate the total price based on ticket counts
...
//   // Confirm ticket selection and proceed to the next step
//   const handleConfirm = () => {
...
//     // Log the full Redux state after dispatch
//     console.log("Redux State After Dispatch in ticket Page:", store.getState());
...
//                 <p className="text-lg sm:text-xl">₹{calculateTotal()}</p>
//               </div>
//               <button
