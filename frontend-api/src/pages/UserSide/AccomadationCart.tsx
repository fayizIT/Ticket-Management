...
const AccomadationCart: React.FC = () => {
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg w-full lg:w-1/2 flex flex-col justify-between h-auto lg:h-[31.7rem]">
            <div>
              <button className="text-blue-600 font-semibold mb-4 flex items-center">
                ...
                Choose Your Accoumadation
              </button>
              <h2 className="text-2xl font-bold mb-4">Choose your Accoumadation</h2>
              <p className="text-gray-700 mb-6 leading-relaxed">
                Grab your Tickect for a weekend of exceitment and fun Our tickect Run out fast so Book now
              </p>
            </div>
          </div>
...
export default AccomadationCart;
