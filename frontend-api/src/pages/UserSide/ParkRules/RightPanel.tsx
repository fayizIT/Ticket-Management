    ...
    <div className="bg-white p-4 rounded-xl shadow-lg border border-gray-200 flex flex-col h-auto max-h-[400px] w-full mx-auto">
      ...
      <div className="flex-grow overflow-y-auto mb-4 pr-2">
        {renderSection("Dress Code Of Fun", "dressCode", activeSection, toggleSection, 
          "Guests are expected to wear comfortable, family-friendly attire. No offensive slogans or images are allowed on clothing.", "text-sm")}
        {renderSection("Special Services", "specialServices", activeSection, toggleSection, 
          "Wheelchairs & Prams are available for Sr. Citizens and Toddlers.", "text-sm")}
